...
<b>I recommend using it ONLY together with <a href="https://1.1.1.1">Cloudflare DNS-over-TLS</a>, <a href="https://www.quad9.net">Quad9 DNS-over-TLS</a> and <a href="https://developers.google.com/speed/public-dns/docs/dns-over-tls">Google DNS-over-TLS</a> at the same time for upstream queries. Also <a href="https://adguard.com/en/welcome.html#products">AdGuard</a> is recomended too.</b>
